...
Input: num = "4321", k = 4
Output: "1342"
Explanation: The steps to obtain the minimum integer from 4321 with 
4 adjacent swaps are shown.

Example 2:
Input: num = "100", k = 1
Output: "010"
Explanation: It's ok for the output to have leading zeros, but the 
input is guaranteed not to have any leading zeros.
...
// modify for min instead of max
// Failed 
class Solution {
public:
    void findMinimumNum(string num, int k, string& min) {
        if(k==0) return;
