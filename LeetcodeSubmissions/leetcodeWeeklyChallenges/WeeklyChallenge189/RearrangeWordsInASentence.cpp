...
/* 
My solution -  Worked for test case, failed in large input
Divide text into words and sort the using lenght.
This way they will be sorted if they are or of different lengths
*/
class Solution {
...
public:
    string arrangeWords(string text) {
        vector<string> holder = divideString(text);
        string ans = "";
        sort(holder.begin(), holder.end(), [](const std::string &l, const std::string &r) { return l.length()<r.length(); });
